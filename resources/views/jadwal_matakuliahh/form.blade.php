<div class="form-group">
	<label class="col-sm-2 control-label" id="mahasiswaa_id">Mahasiswa</label>
	<div class="col-sm-10">
	{!! Form::select('mahasiswaa_id',$mahasiswaa->listMahasiswaDanNim(),null,['class'=>'form-control','id'=>'mahasiswaa_id','placeholder'=>"mahasiswaa"]) !!}
	</div>
	</div>
<div class="form-group">
